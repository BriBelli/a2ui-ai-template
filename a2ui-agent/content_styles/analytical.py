...
TEMPORAL: Time-series should use recent trailing months ending at the current date. Never title a chart with an older year. (See RELEVANCE rule above for full temporal/geographic requirements.)
