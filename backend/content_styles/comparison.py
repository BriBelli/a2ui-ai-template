...
TEMPORAL: All comparisons must use current-generation products, versions, specs, and pricing. Reference the latest models — never training-data-era model numbers. If uncertain about current specs, use most recent known and note it. (See RELEVANCE rule above for full requirements.)
...
{"text":"**iPhone vs Android**: iPhone leads in ecosystem integration and privacy; Android dominates in customization and value range.","a2ui":{"version":"1.0","components":[{"id":"ch","type":"chart","props":{"chartType":"bar","title":"Feature Ratings (1-10)","data":{"labels":["Camera","Battery","Display","Performance","AI","Value"],"datasets":[{"label":"iPhone (latest Pro)","data":[9,8,9,9,8,7]},{"label":"Android (latest flagship)","data":[10,8,9,9,9,7]}]},"options":{"xAxisLabel":"Feature","yAxisLabel":"Rating (1-10)"}}},{"id":"t","type":"data-table","props":{"columns":[{"key":"f","label":"Feature"},{"key":"a","label":"iPhone"},{"key":"b","label":"Android"}],"data":[{"f":"OS","a":"Latest iOS","b":"Latest Android"},{"f":"Ecosystem","a":"Apple integrated","b":"Open, customizable"},{"f":"AI","a":"Apple Intelligence","b":"Google Gemini"},{"f":"Camera","a":"48MP ProRes","b":"200MP expert RAW"},{"f":"Price Range","a":"$799–$1599","b":"$199–$1799"},{"f":"Update Support","a":"6+ years","b":"7 years (Samsung)"},{"f":"Security","a":"Face ID, Secure Enclave","b":"Fingerprint, Knox"},{"f":"Charging","a":"MagSafe USB-C","b":"USB-C fast charge"}]}}]},"suggestions":["Latest iPhone Pro vs Galaxy S Ultra camera comparison","Best budget Android phones right now"]}""",
}
